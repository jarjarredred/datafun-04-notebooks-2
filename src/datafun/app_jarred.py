...
def make_plots(df_clean: pd.DataFrame) -> None:
    """Create plots and automatically save them to the artifacts folder.

    WHY: Saving plots locally preserves our discoveries for reports or portfolios
    without needing to regenerate them every time.
    """
    # 1. Define and create the artifacts directory if it doesn't exist
